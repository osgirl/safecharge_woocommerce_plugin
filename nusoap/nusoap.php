...
class soap_transport_http extends nusoap_base {
	...
	* @access public
	*/
	function construct($url, $curl_options = NULL, $use_curl = false){
		parent::nusoap_base();
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function construct($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=30,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
...
class nusoap_parser extends nusoap_base {
	...
	* @access   public
	*/
	function construct($xml,$encoding='UTF-8',$method='',$decode_utf8=true){
		parent::nusoap_base();
		$this->xml = $xml;
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function construct($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
		parent::nusoap_base();
